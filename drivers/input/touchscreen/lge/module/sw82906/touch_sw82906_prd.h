...
#ifndef TOUCH_SW82906_PRD_H
#define TOUCH_SW82906_PRD_H
...
/* Chanel settings */
#define MAX_CHANNEL		(50)	//<ROW>
#define COL_MAX_CHANNEL		(40)
#define ROW_SIZE		(42)	
#define COL_SIZE		(32)	
