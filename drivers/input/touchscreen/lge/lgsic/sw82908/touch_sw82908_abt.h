...
#ifndef TOUCH_SW82908_ABT_H
#define TOUCH_SW82908_ABT_H
...
extern int sw82908_abt_register_sysfs(struct device *dev);
extern int sw82908_abt_unregister_sysfs(struct device *dev);

#endif	/* TOUCH_SW82908_ABT_H */
